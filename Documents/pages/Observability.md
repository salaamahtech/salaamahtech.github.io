	  ...
	  collapsed:: true
		...
		- ### Frontend Monitoring
		  collapsed:: true
			...
			- **Synchronous loading**: By default, scripts in a webpage are loaded synchronously. i.e., if the DOM parsing encounters a `<script>` tag, then the browser will stop parsing the DOM and load the script.
